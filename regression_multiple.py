...
final_teta_value, cost_history = gradient_descent(X, y, teta, alpha = 0.01, n_iteration = 1000)
...
plt.scatter(x[:,0],y)
plt.scatter(x[:,0], prediction_vector,c = 'r')
plt.show()
plt.scatter(x[:,1],y)
plt.scatter(x[:,1], prediction_vector,c = 'r')
plt.show()
